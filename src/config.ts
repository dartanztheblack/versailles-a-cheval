...
export const addOnOptions: AddOnOption[] = [
  ...
  },
  {
    ...
    description: "Un déjeuner exclusif signé par le Chef étoilé Alain Ducasse : l'ultime gastronomie française. Entrée, plat, dessert et boisson.",
    descriptionEn: "An exclusive lunch by starred Chef Alain Ducasse: the ultimate French gastronomy. Starter, main course, dessert and drink.",
    price: 200,
  },
  {
    id: "lunch_bistro",
    ...
    description: "Déjeuner dans l'un des restaurants officiels du Château de Versailles. Entrée, plat, dessert et boisson.",
    descriptionEn: "Lunch at one of the official restaurants of the Palace of Versailles. Starter, main course, dessert and drink.",
    price: 100,
  },
  {
    id: "transport",
